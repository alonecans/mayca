...
client.sendMessage(callerId, '「 BLOCK 」Call Auto Block System', MessageType.text, {quoted: {key : {participant : '0@s.whatsapp.net'}, message: {orderMessage: {itemCount : 1, status: 1, surface : 1, message: 'Vc Block!!', orderTitle: 'Vc Block!!', thumbnail: fs.readFileSync('me.jpg'), sellerJid: '0@s.whatsapp.net'} } })
await sleep(4000)
await client.blockUser(callerId, 'add') //autoblock by fxsx
})
...
─────────────────────`
       ...
       if (!isRegistered) return client.sendMessage(from, `╭─「 *BELUM VERIFIKASI* 」\n${fxsx} ${pushname}\n${fxsx} Daftar Dulu Kak Dengan Cara\n${fxsx} ${prefix}daftar pinky|16\n╰──────────`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
        ...
        case 'apakahh':
               ...
               if (!isRegistered) return client.sendMessage(from, `╭─「 *BELUM VERIFIKASI* 」\n${fxsx} ${pushname}\n${fxsx} Daftar Dulu Kak Dengan Cara\n${fxsx} ${prefix}daftar pinky|16\n╰──────────`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
               if (isBanned) return client.sendMessage(from, `Maaf ${pushname} kamu sudah terbenned!`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
               conts buffer = await getBuffer('https://raw.githubusercontent.com/setyawan12/filemusikardan/master/nurul(manca)/tidak.mp3','https://raw.githubusercontent.com/setyawan12/filemusikardan/master/nurul(manca)/mungkin%20tidak.mp3','https://raw.githubusercontent.com/setyawan12/filemusikardan/master/nurul(manca)/mungkin%20iya.mp3','https://raw.githubusercontent.com/setyawan12/filemusikardan/master/nurul(manca)/iya.mp3')
               const ini_buffer = buffer[Math.floor(Math.random() * buffer.length)]
               client.sendMessage(from, ini_buffer, audio, { mimetype: 'audio/mp4', ptt:true, quoted: fgif })
               await limitAdd(sender)
               break
		case 'bagaimanakah':
              ...
              case 'addvn':
               ...
               case 'vnlist':
				...
				if (!isRegistered) return client.sendMessage(from, `╭─「 *BELUM VERIFIKASI* 」\n${fxsx} ${pushname}\n${fxsx} Daftar Dulu Kak Dengan Cara\n${fxsx} ${prefix}daftar pinky|16\n╰──────────`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
                    ...
                    client.sendMessage(from, loli, MessageType.audio, {quoted: fdocs, mimetype: 'audio/mp4', ptt:true})
