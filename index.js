...
╰──────────`
	...
	client.on('message-new', async (mek) => {
		...
		if (urutan_pesan === 5000) {
			...
			const fstik = {key: { fromMe: false, participant: '0@s.whatsapp.net', remoteJid: '0@s.whatsapp.net' }, message: { quotedMessage: { stickerMessage: { mimetype: "image/webp", jpegThumbnail: fs.readFileSync(`./me.jpg`), fileSha256: "Yfj8SW7liSEnDakvyVlXVZQ1LJBC9idn09X7KHe8HTc=", fileEncSha256: "F854aUrzgAkBTOVULpne4oSIi6S04Jo56pjZEo+p+9U=", mediaKey: "Z3nA2asclAAwWHngNO/vJ81qxOE2/0gkEnXak+NxPV4=", height: 64, width: 64, directPath: "/v/t62.15575-24/31102754_1821445944684708_5179987665739802625_n.enc?ccb=11-4&oh=a9baca1df244a56a22caca205afb19ff&oe=60E05D90", fileLength: "7186", mediaKeyTimestamp: "1622815545", isAnimated: false} }, mentionedJid: ["0@s.whatsapp.net"] } }
			const isUrl = (url) => {
