		...
		case 'chat':
          ...
          case 'circle':
               ...
               break
					...
					if (!isOwner) return client.sendMessage(from, '「 OWNER BOT ONLY 」',MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
					fxsx = args[0]
					client.sendMessage(from, `FxSx berhasil di ubah menjadi : ${fxsx}`,MessageType.text, { quoted: flokasi, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
					break
				case 'fuckboy':
				case 'fuckgirl':
				case 'bucinserti':
...
╭─「 *GROUP MENU* 」
${fxsx} ${prefix}welcome [on/off]
${fxsx} ${prefix}nsfw [on/off]
${fxsx} ${prefix}antilink [on/off]
${fxsx} ${prefix}antibadword [on/off]
${fxsx} ${prefix}simih [on/off] 
...
${fxsx} ${prefix}asupan
${fxsx} ${prefix}asupansantuy
${fxsx} ${prefix}asupanbocil
${fxsx} ${prefix}asupanukhty
${fxsx} ${prefix}asupanrikagusriani
${fxsx} ${prefix}asupanghea
╰──────────
...
buffer = await getBuffer('https://raw.githubusercontent.com/alonecans/foto-manca/main/me.jpg')
              ...
              case 'vnlist':
				...
				if (!isRegistered) return reply(ind.noregis())
					...
					if (messagesC.includes(`${awokwkwk}`)){
					namastc = body.slice(7)
                    buffer = fs.readFileSync(`./storage/audio/${namastc}.mp3`)
                    client.sendMessage(from, buffer, MessageType.audio, {quoted: fvideo, mimetype: 'audio/mp4', ptt:true, duration:999999999999})
                    }
		...
		case 'kodenegara':
				...
				if (isBanned) return client.sendMessage(from, `Maaf ${pushname} kamu sudah terbenned!`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
					...
					await limitAdd(sender)
					break
        if (body.startsWith('delete.webp')) {
                 if (!isRegistered) return client.sendMessage(from, `╭─「 *BELUM VERIFIKASI* 」\n${fxsx} ${pushname}\n${fxsx} Daftar Dulu Kak Dengan Cara\n${fxsx} ${prefix}daftar pinky|16\n╰──────────`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
				if (isBanned) return client.sendMessage(from, `Maaf ${pushname} kamu sudah terbenned!`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
