...
pp_user = 'https://i.ibb.co/tskRN4r/manca.jpg'
}
pp_nuy = await getBuffer(pp_user)
                    client.sendMessage(from, pp_nuy, image, {quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true, mentionedJid: [ow, num]}, displayname: mem, caption: menusu })
					break
                  case 'addstic':
                case 'adds':
				    if (!isRegistered) return reply( ind.noregis())
