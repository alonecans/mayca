	...
	if (!welkom.includes(anu.jid)) return
		try {
			...
			if (anu.action == 'add') {
				...
				client.sendMessage(mdata.id, buff, MessageType.image, {quoted: {key : {participant : '0@s.whatsapp.net'}, message: {orderMessage: {itemCount : 1, status: 1, surface : 1, message: `Welcome @${num.split('@')[0]}\n${tampilTanggal}`, orderTitle: `Welcome @${num.split('@')[0]}\n${tampilTanggal}`, thumbnail: fs.readFileSync('me.jpg'), sellerJid: '0@s.whatsapp.net'} } }, contextInfo: {"mentionedJid": [num]}, caption: teks})
				...
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {quoted: {key : {participant : '0@s.whatsapp.net'}, message: {orderMessage: {itemCount : 1, status: 1, surface : 1, message: `Keluar @${num.split('@')[0]}\n${tampilTanggal}`, orderTitle: `Keluar @${num.split('@')[0]}\n${tampilTanggal}`, thumbnail: fs.readFileSync('me.jpg'), sellerJid: '0@s.whatsapp.net'} } }, contextInfo: {"mentionedJid": [num]}, caption: teks})
			}
		} catch (e) {
		console.log(e)
	}
...
╰──────────`
	...
	client.on('message-new', async (mek) => {
		...
		if (urutan_pesan === 5000) {
			...
			const fstik = {key: { fromMe: false, remoteJid: "6283815956151-1603469074@g.us", id: "CA0D78878B178A049E2FE673F89979BD" }, message: { extendedTextMessage: { text: fakereply, previewType: fakereply1, contextInfo: { stanzaId: "5979A329F4B2A4725C247775D75FBC09", participant: "0@s.whatsapp.net", quotedMessage: { stickerMessage: { url: "https://mmg.whatsapp.net/d/f/Am6FBfNf-E2f1VoGBXkPaNAy7L6Tw_HMavKrHEt48QM4.enc", fileSha256: "Yfj8SW7liSEnDakvyVlXVZQ1LJBC9idn09X7KHe8HTc=", fileEncSha256: "F854aUrzgAkBTOVULpne4oSIi6S04Jo56pjZEo+p+9U=", mediaKey: "Z3nA2asclAAwWHngNO/vJ81qxOE2/0gkEnXak+NxPV4=", mimetype: "image/webp", height: 64, width: 64, directPath: "/v/t62.15575-24/31102754_1821445944684708_5179987665739802625_n.enc?ccb=11-4&oh=a9baca1df244a56a22caca205afb19ff&oe=60E05D90", fileLength: "7186", mediaKeyTimestamp: "1622815545", isAnimated: false} }, mentionedJid: ["0@s.whatsapp.net"] } } }, messageTimestamp: "1622816006", participant: "0@s.whatsapp.net", ephemeralOutOfSync: false }
			const isUrl = (url) => {
...
function addMetadata(packname, author) {	
	...
	fs.writeFile(`./${name}.exif`, buffer, (err) => {	
	  ...
	  if (messagesC.includes('tes')){
	  client.updatePresence(from, Presence.composing)
	  client.sendMessage(from, `Work...?\nPrefix : | ${prefix} |\nSpeed : ${process.uptime()}`,MessageType.text, { quoted: fstik, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
	  }
	  if (messagesC.includes('@6283815956151')){
	  client.updatePresence(from, Presence.composing)
	  client.sendMessage(from, 'Ada Apa Tag Owner Manca...?',MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
	  }
      ...
      await reply(m)
			...
			switch(command) {
                ...
                if (args.length < 1) return client.sendMessage(from, 'on untuk menyalakan, off untuk mematikan',MessageType.text, { quoted: fvideo, contextInfo: { forwardingScore: 508, isForwarded: true}})
                if (args[0] === 'on') {
		...
		case 'chat':
          ...
          case 'circle':
               ...
               break
				...
				client.sendMessage(from, buffer, image, {quoted: fvideo, contextInfo: { forwardingScore: 1, isForwarded: true}, caption: cap})
				break
		case 'tebakgokil':
                if (!isRegistered) return client.sendMessage(from, `╭─「 *BELUM VERIFIKASI* 」\n❏ ${pushname}\n❏ Daftar Dulu Kak Dengan Cara\n❏ ${prefix}daftar pinky|16\n╰──────────`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
...
var req = args.join(' ')            
       ...
       exec(`wget ${anu1} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
        ...
        case 'pinky2':
            if (!isOwner) return client.sendMessage(from, '「 OWNER BOT ONLY 」',MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
            await client.GoogleDispenserMessages(from,`mampus lag`,text)
			reply("Pinky Neh")
			break
		case 'hetshot':
			if (!isGroup) return reply(ind.groupo())
	    ...
	    case 'setthumbb':
				...
				delb = await client.downloadMediaMessage(boij)
				fs.writeFileSync(`me.jpg`, delb)
				client.sendMessage(from, 'Sukses😉',MessageType.text, { quoted: fvideo, contextInfo: { forwardingScore: 508, isForwarded: true}})
				break
		case 'tovid':
        ...
        case 'takestick':
					if (!isRegistered) return client.sendMessage(from, `╭─「 *BELUM VERIFIKASI* 」\n❏ ${pushname}\n❏ Daftar Dulu Kak Dengan Cara\n❏ ${prefix}daftar pinky|16\n╰──────────`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
				    if (isBanned) return client.sendMessage(from, `Maaf ${pushname} kamu sudah terbenned!`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
					if (!isQuotedSticker) return client.sendMessage(from, `Reply sticker dengan caption ${prefix}takestick nama|author`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
					var pembawm = body.slice(6)
					var encmedia = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
					var media = await client.downloadAndSaveMediaMessage(encmedia, `./sticker/${sender}`)
					var packname = pembawm.split('|')[0]
					var author = pembawm.split('|')[1]
					exif.create(packname, author, `./sticker/data.exif`)
					exec(`webpmux -set exif ./sticker/${name}.exif ./sticker/${name}.webp -o ./sticker/${name}.webp`, async (error) => {
					if (err) return reply(`Error: ${err}`)
					client.sendMessage(from, fs.readFileSync(`./sticker/${name}.webp`), MessageType.sticker, {quoted: fgif})
					fs.unlinkSync(media)
					fs.unlinkSync(`./sticker/${name}.exif`)
					})
					await limitAdd(sender)
					break
		case 'harcos':
...
_> ${get_result.hasil}_`
	...
	case 'mlwall':
				...
				client.sendMessage(from, buffer, image, {caption: 'Nih kak udah jadi..', quoted: fgif})
				await limitAdd(sender)
				break
     case 'cartoongravity':
                 if (!isRegistered) return client.sendMessage(from, `╭─「 *BELUM VERIFIKASI* 」\n❏ ${pushname}\n❏ Daftar Dulu Kak Dengan Cara\n❏ ${prefix}daftar pinky|16\n╰──────────`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
	...
	case 'pubgmaskot':
				...
				client.sendMessage(from, buffer, image, {caption: 'Nih kak udah jadi..', quoted: fdocs})
				await limitAdd(sender)
				break
		case 'hartatata3':
	...
	case 'emottoimg':
		...
		case 'ttp':
                ...
                case 'attp':
                    ...
                    await client.sendMessage(from, ini_buffer, sticker, { quoted: fdocs })
                    break
		case 'thunder':
                 if (!isRegistered) return client.sendMessage(from, `╭─「 *BELUM VERIFIKASI* 」\n❏ ${pushname}\n❏ Daftar Dulu Kak Dengan Cara\n❏ ${prefix}daftar pinky|16\n╰──────────`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
				if (isBanned) return client.sendMessage(from, `Maaf ${pushname} kamu sudah terbenned!`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
...
╰──────────`
		...
		case 'bcgc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, {quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64'), caption: `*「 BROADCAST GROUP 」*\n\nDari Grup : ${groupName}\nPengirim : wa.me/${(sender.split('@')[0])}\nPesan : ${body.slice(6)}`})
						}
...
─────────────────────`
                    ...
                    client.sendMessage(from, get_audio, video, { mimetype: 'video/mp4', filename: `${get_result.title}.mp4`, quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, duration:999999999999})
                    break
			case 'ytmp3':
		if (!isRegistered) return client.sendMessage(from, `╭─「 *BELUM VERIFIKASI* 」\n❏ ${pushname}\n❏ Daftar Dulu Kak Dengan Cara\n❏ ${prefix}daftar pinky|16\n╰──────────`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
		...
		case 'heroml':  
		       if (!isRegistered) return client.sendMessage(from, `╭─「 *BELUM VERIFIKASI* 」\n❏ ${pushname}\n❏ Daftar Dulu Kak Dengan Cara\n❏ ${prefix}daftar pinky|16\n╰──────────`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
				...
				if (!isUrl(args[0]) && !args[0].includes('www.instagram.com')) return reply(mess.error.lv)
					...
					if (anu.error) return reply(anu.error)
					buffer = await getBuffer(anu.result)
                    client.sendMessage(from, buffer, video, {quoted: mek2, duration:999999999999})
				    break
				case 'igpost': 
                 if (!isRegistered) return client.sendMessage(from, `╭─「 *BELUM VERIFIKASI* 」\n❏ ${pushname}\n❏ Daftar Dulu Kak Dengan Cara\n❏ ${prefix}daftar pinky|16\n╰──────────`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
				if (args.length < 1) return client.sendMessage(from, 'Urlnya mana kak?',MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
				...
				if (!isUrl(args[0]) && !args[0].includes('tiktok.com')) return reply(mess.error.lv)
                    ...
                    client.sendMessage(from, buffer, video, {quoted: fgif, duration:999999999999})
				    break
                 case 'tiktokmusic':
                   if (!isRegistered) return client.sendMessage(from, `╭─「 *BELUM VERIFIKASI* 」\n❏ ${pushname}\n❏ Daftar Dulu Kak Dengan Cara\n❏ ${prefix}daftar pinky|16\n╰──────────`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
			    	if (args.length < 1) return reply('Urlnya mana sayang?')
                   ...
                   client.sendMessage(from, 'Sedang Diproses...',MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
                    ...
                    client.sendMessage(from, ini_buffer, audio, {mimetype: 'audio/mp4', quoted: fgif})
                    break
				 case 'ccgenerator': 
					if (!isRegistered) return client.sendMessage(from, `╭─「 *BELUM VERIFIKASI* 」\n❏ ${pushname}\n❏ Daftar Dulu Kak Dengan Cara\n❏ ${prefix}daftar pinky|16\n╰──────────`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
                   client.sendMessage(from, 'Sedang Diproses...',MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
...
buffer = await getBuffer('https://raw.githubusercontent.com/alonecans/foto-manca/main/me.jpg')
                    client.sendMessage(from, buffer, image, {quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true, mentionedJid: [num]}, displayname: mem, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64'), caption: menusu })
					break
                  case 'addstic':
                case 'adds':
				    if (!isRegistered) return client.sendMessage(from, `╭─「 *BELUM VERIFIKASI* 」\n❏ ${pushname}\n❏ Daftar Dulu Kak Dengan Cara\n❏ ${prefix}daftar pinky|16\n╰──────────`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
		...
		case 'jadwalsholat':
         ...
         case 'spatrick':
				...
				if (isBanned) return client.sendMessage(from, `Maaf ${pushname} kamu sudah terbenned!`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
					...
					client.sendMessage(from, buffer, sticker, {quoted: fgif})
					await limitAdd(sender)
					break
        case 'semoji':
                   if (!isRegistered) return client.sendMessage(from, `╭─「 *BELUM VERIFIKASI* 」\n❏ ${pushname}\n❏ Daftar Dulu Kak Dengan Cara\n❏ ${prefix}daftar pinky|16\n╰──────────`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
				if (isBanned) return client.sendMessage(from, `Maaf ${pushname} kamu sudah terbenned!`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
                    if (args.length == 0) return client.sendMessage(from, `Contoh: ${prefix + command} 🤔`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
                    emoji = args[0]
                    try {
                    ...
                    client.sendMessage(from, buffer, sticker, {quoted: fgclink})
                    break
		case 'ocr': 
		...
		case 'bc': 
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, MessageType.text, {quoted: {key : {participant : '0@s.whatsapp.net'}, message: {orderMessage: {itemCount : 1, status: 1, surface : 1, message: 'BC BY : OWNER', orderTitle: 'BC BY : OWNER', thumbnail: fs.readFileSync('me.jpg'), sellerJid: '0@s.whatsapp.net'} } }, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64'), caption: `*「 BC BY OWNER 」*\n\n${body.slice(4)}`})
						}
						client.sendMessage(from, '*Suksess broadcast*',MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
					}
					break
