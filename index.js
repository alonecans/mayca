	...
	if (!welkom.includes(anu.jid)) return
		try {
			...
			if (anu.action == 'add') {
				...
				let loli = fs.readFileSync('./mp3/member.mp3')
				client.sendMessage(from, loli, MessageType.audio, {quoted: flokasi, contextInfo: {"mentionedJid": [num]}, mimetype: 'audio/mp4', ptt:true, duration:999999999999})
